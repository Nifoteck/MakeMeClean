...
export default function Bookings() {
  ...
  const serviceIcons: Record<string, string> = {
    "standard-cleaning": "🏠", "deep-cleaning": "✨", "one-off-cleaning": "🔑",
    "same-day-cleaning": "⚡", "airbnb-cleaning": "🏡", "ironing-service": "👔",
    "cleaning-and-ironing": "🌟", "window-cleaning": "🪟", "spring-cleaning": "🌸",
        ...
        {filtered.length === 0 ? (
          ...
          <div className="space-y-3">
            {filtered.map((b) => (
              ...
              >
                <div className="w-12 h-12 bg-green-50 border border-green-100 rounded-xl flex items-center justify-center text-2xl shrink-0">
                  {serviceIcons[b.service_type] ?? "🧹"}
                </div>
