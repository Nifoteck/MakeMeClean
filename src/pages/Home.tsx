...
const testimonials = [
  {
    ...
    city: "Cardiff",
    rating: 5,
    text: "I was a bit hesitant booking online at first, but the whole thing took less than three minutes and the cleaner arrived exactly on time. My kitchen looks brand new — haven't seen it this clean since we moved in.",
  ...
  },
  {
    ...
    city: "Swansea",
    rating: 5,
    text: "I use MakeMeClean for my Airbnb between every guest. The turnaround is quick, the standard is consistent, and guests always comment on the cleanliness. Worth every penny.",
  ...
  },
  {
    ...
    city: "Newport",
    rating: 5,
    text: "Booked a deep clean for our new house before moving in properly. They went through everything — oven, skirting boards, inside cupboards. Felt genuinely fresh when we finally moved our things in.",
  ...
  },
  {
    ...
    city: "Wrexham",
    rating: 5,
    text: "Called at 9am needing a same-day clean before the in-laws arrived. Booked online in two minutes, cleaner was there by noon. Absolute lifesaver. Already booked a monthly clean going forward.",
...
export default function Home() {
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      {/* ── Hero ──────────────────────────────────── */}
      <section className="relative bg-white pt-12 pb-0 md:pt-20">
        {/* Background accent */}
        <div className="absolute inset-0 hero-gradient pointer-events-none" />
        <div className="absolute top-0 right-0 w-[600px] h-[600px] dot-pattern opacity-40 pointer-events-none" />

        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center pb-16 md:pb-24">

            {/* Left */}
            <div className="animate-fade-in-up">
              <div className="inline-flex items-center gap-2 bg-green-50 border border-green-100 text-green-700 text-xs font-semibold px-3.5 py-1.5 rounded-full mb-7 tracking-wide">
              ...
              <p className="text-lg text-gray-500 leading-relaxed mb-9 max-w-md">
                We clean homes in Cardiff, Newport, Swansea, and everywhere in between. Book in a few taps, trust the result.
              </p>
              ...
              <div className="flex items-center gap-5 pt-4 border-t border-gray-100">
                ...
                <div>
                  <p className="text-xs text-gray-500 leading-tight">
                    Fully insured, vetted cleaners — book online in minutes
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative animate-fade-in-up stagger-2 hidden lg:block">
              ...
              {/* Floating stat */}
              <div className="absolute -bottom-5 -left-8 bg-white rounded-2xl shadow-xl border border-gray-100 p-4 flex items-center gap-3.5">
                <div className="w-11 h-11 bg-green-100 rounded-xl flex items-center justify-center shrink-0">
                  <CheckCircle className="w-6 h-6 text-green-600" />
                </div>
                <div>
                  <p className="text-sm font-bold text-gray-900 leading-tight">Booking confirmed!</p>
                  <p className="text-xs text-gray-400">Deep Clean · Tomorrow 10:00am</p>
                </div>
              </div>

              {/* Floating trust badge */}
              <div className="absolute -top-5 -right-5 bg-white rounded-2xl shadow-xl border border-gray-100 p-3.5 flex items-center gap-2.5">
                <div className="w-10 h-10 bg-green-100 rounded-xl flex items-center justify-center shrink-0">
                  <Shield className="w-5 h-5 text-green-700" />
                </div>
                <div>
                  <p className="text-sm font-bold text-gray-900 leading-tight">Vetted & insured</p>
                  <p className="text-[10px] text-gray-400">Trusted cleaners, every visit</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-gray-900 py-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-0 divide-x divide-gray-700/60">
            {[
              { n: "Trusted", label: "Local cleaners across Wales" },
              { n: "Vetted", label: "Background-checked cleaners" },
              { n: "11", label: "Services offered" },
              { n: "7 days", label: "A week, 8am–8pm" },
            ].map(({ n, label }) => (
              <div key={label} className="text-center px-6 py-2 first:pl-0 last:pr-0">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative hidden lg:block">
              ...
              {/* Trust badge */}
              <div className="absolute bottom-8 left-8 right-8 bg-white/95 backdrop-blur-sm rounded-2xl p-5 border border-gray-100 shadow-lg">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-green-600 rounded-xl flex items-center justify-center shrink-0">
                    <Award className="w-5 h-5 text-white" />
                  </div>
                  <div>
                    <p className="font-bold text-gray-900 text-sm">Satisfaction Guarantee</p>
                    <p className="text-xs text-gray-500">Not happy? We'll return and re-clean, no questions asked.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            {/* Connector line */}
            <div className="hidden md:block absolute top-10 left-[calc(16.6%+20px)] right-[calc(16.6%+20px)] h-px bg-gradient-to-r from-green-200 via-green-400 to-green-200" />
            ...
            {[
              ...
              <div key={n} className="relative text-center">
                <div className="w-20 h-20 green-gradient rounded-2xl flex items-center justify-center mx-auto mb-6 text-white text-3xl font-black shadow-green-sm relative z-10">
                  {n}
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-2" style={{ fontFamily: "Outfit, sans-serif" }}>{title}</h3>
      ...
      <section className="py-20 green-gradient">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            >
              <Phone className="w-4 h-4" /> +44 7362 068202
            </a>
          </div>
        </div>
      </section>
