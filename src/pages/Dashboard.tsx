...
import { Calendar, Clock, User, ArrowRight, Plus, FileText } from "lucide-react";
  ...
  useEffect(() => {
    ...
    const load = async () => {
      const [{ data: b }, { data: p }] = await Promise.all([
        supabase
          .from("bookings")
          .select("id, service_name, date, time_slot, status, price, invoice_number")
          .eq("user_id", user.id)
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {[
            ...
            { icon: User, label: "Account", value: "Active", color: "bg-emerald-100 text-emerald-600" },
